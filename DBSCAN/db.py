"""
This is an implementation of dbscan on Textual Data
@author: Srishti
"""
...
my_labels = MyDBSCAN(tfidf, 0.19, 2)
json = json.dumps(my_labels)
f = open("db_cluster_short.json","w")
f.write(json)
f.close()
print(my_labels)